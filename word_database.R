...
pos.words = scan('C:/Users/acerpc/Documents/GitHub/positive-words.txt', what='character', comment.char=';') 
neg.words = scan('C:/Users/acerpc/Documents/GitHub/negative-words.txt', what='character', comment.char=';')
